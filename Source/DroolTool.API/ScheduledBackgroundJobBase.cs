...
namespace DroolTool.API
{
    public abstract class ScheduledBackgroundJobBase<T>
    {
        ...
        protected readonly DroolToolDbContext _dbContext;
        ...
        protected ScheduledBackgroundJobBase(string jobName, ILogger<T> logger, IWebHostEnvironment webHostEnvironment, DroolToolDbContext dbContext)
        {
            _jobName = jobName;
            _logger = logger;
