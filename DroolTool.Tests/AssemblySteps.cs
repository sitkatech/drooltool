...
namespace DroolTool.Tests
{
    ...
    public static class AssemblySteps
    {
        ...
        public static DroolToolDbContext DbContext;
        ...
        public static async Task AssemblyInitialize(TestContext testContext)
        {
            ...
            var dbOptions = new DbContextOptionsBuilder<DroolToolDbContext>();
            dbOptions.UseSqlServer(dbCS, x => x.UseNetTopologySuite());
            var dbContext = new DroolToolDbContext(dbOptions.Options);
