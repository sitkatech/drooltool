...
/****** Object:  Table [dbo].[RawDroolMetric]    Script Date: 7/14/2020 2:31:10 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[RawDroolMetricStaging](
	...
	[overall_sprinkler_nozzles_rebate_sum] [float] NULL,
	...
	[overall_daily_outdoor_budget_per_irrig_area] [float] NULL,
	...
	[overall_pct_diff_12mo_meter_over_total_budget_fraction] [float] NULL,
	[overall_pct_diff_12mo_daily_meter_budget_overage_per_meter] [float] NULL,
	[overall_pct_diff_12mo_meter_over_est_outdoor_budget_fraction] [float] NULL,
	[overall_pct_diff_12mo_daily_meter_usage_per_capita_mean] [float] NULL,
	[overall_pct_diff_12mo_daily_meter_est_outdoor_usage_per_capita_mean] [float] NULL,
	[overall_pct_diff_12mo_daily_meter_budget_overage_fraction_total] [float] NULL,
	[overall_pct_diff_12mo_daily_est_outdoor_usage_per_irrig_area] [float] NULL,
	[overall_pct_diff_12mo_daily_est_outdoor_budget_overage_per_irrig_area] [float] NULL,
	[overall_pct_diff_12mo_daily_est_outdoor_budget_overage_fraction_outdoor_budget] [float] NULL,
	[overall_pct_diff_12mo_rebate_participation_fraction] [float] NULL,
	[overall_pct_diff_12mo_turf_rebate_area_fraction] [float] NULL,
	...
	[reshoa_sprinkler_nozzles_rebate_sum] [float] NULL,
	...
	[reshoa_daily_outdoor_budget_per_irrig_area] [float] NULL,
	...
	[reshoa_pct_diff_12mo_meter_over_total_budget_fraction] [float] NULL,
	[reshoa_pct_diff_12mo_daily_meter_budget_overage_per_meter] [float] NULL,
	[reshoa_pct_diff_12mo_meter_over_est_outdoor_budget_fraction] [float] NULL,
	[reshoa_pct_diff_12mo_daily_meter_usage_per_capita_mean] [float] NULL,
	[reshoa_pct_diff_12mo_daily_meter_est_outdoor_usage_per_capita_mean] [float] NULL,
	[reshoa_pct_diff_12mo_daily_meter_budget_overage_fraction_total] [float] NULL,
	[reshoa_pct_diff_12mo_daily_est_outdoor_usage_per_irrig_area] [float] NULL,
	[reshoa_pct_diff_12mo_daily_est_outdoor_budget_overage_per_irrig_area] [float] NULL,
	[reshoa_pct_diff_12mo_daily_est_outdoor_budget_overage_fraction_outdoor_budget] [float] NULL,
	[reshoa_pct_diff_12mo_rebate_participation_fraction] [float] NULL,
	[reshoa_pct_diff_12mo_turf_rebate_area_fraction] [float] NULL,
	...
	[res_sprinkler_nozzles_rebate_sum] [float] NULL,
	...
	[res_daily_outdoor_budget_per_irrig_area] [float] NULL,
	...
	[res_pct_diff_12mo_meter_over_total_budget_fraction] [float] NULL,
	[res_pct_diff_12mo_daily_meter_budget_overage_per_meter] [float] NULL,
	[res_pct_diff_12mo_meter_over_est_outdoor_budget_fraction] [float] NULL,
	[res_pct_diff_12mo_daily_meter_usage_per_capita_mean] [float] NULL,
	[res_pct_diff_12mo_daily_meter_est_outdoor_usage_per_capita_mean] [float] NULL,
	[res_pct_diff_12mo_daily_meter_budget_overage_fraction_total] [float] NULL,
	[res_pct_diff_12mo_daily_est_outdoor_usage_per_irrig_area] [float] NULL,
	[res_pct_diff_12mo_daily_est_outdoor_budget_overage_per_irrig_area] [float] NULL,
	[res_pct_diff_12mo_daily_est_outdoor_budget_overage_fraction_outdoor_budget] [float] NULL,
	[res_pct_diff_12mo_rebate_participation_fraction] [float] NULL,
	[res_pct_diff_12mo_turf_rebate_area_fraction] [float] NULL,
	...
	[com_sprinkler_nozzles_rebate_sum] [float] NULL,
	...
	[com_daily_outdoor_budget_per_irrig_area] [float] NULL,
	...
	[com_pct_diff_12mo_meter_over_total_budget_fraction] [float] NULL,
	[com_pct_diff_12mo_daily_meter_budget_overage_per_meter] [float] NULL,
	[com_pct_diff_12mo_meter_over_est_outdoor_budget_fraction] [float] NULL,
	[com_pct_diff_12mo_daily_meter_usage_per_capita_mean] [float] NULL,
	[com_pct_diff_12mo_daily_meter_est_outdoor_usage_per_capita_mean] [float] NULL,
	[com_pct_diff_12mo_daily_meter_budget_overage_fraction_total] [float] NULL,
	[com_pct_diff_12mo_daily_est_outdoor_usage_per_irrig_area] [float] NULL,
	[com_pct_diff_12mo_daily_est_outdoor_budget_overage_per_irrig_area] [float] NULL,
	[com_pct_diff_12mo_daily_est_outdoor_budget_overage_fraction_outdoor_budget] [float] NULL,
	[com_pct_diff_12mo_rebate_participation_fraction] [float] NULL,
	[com_pct_diff_12mo_turf_rebate_area_fraction] [float] NULL,
	...
	[city_sprinkler_nozzles_rebate_sum] [float] NULL,
	...
	[city_daily_outdoor_budget_per_irrig_area] [float] NULL,
	...
	[city_pct_diff_12mo_meter_over_total_budget_fraction] [float] NULL,
	[city_pct_diff_12mo_daily_meter_budget_overage_per_meter] [float] NULL,
	[city_pct_diff_12mo_meter_over_est_outdoor_budget_fraction] [float] NULL,
	[city_pct_diff_12mo_daily_meter_usage_per_capita_mean] [float] NULL,
	[city_pct_diff_12mo_daily_meter_est_outdoor_usage_per_capita_mean] [float] NULL,
	[city_pct_diff_12mo_daily_meter_budget_overage_fraction_total] [float] NULL,
	[city_pct_diff_12mo_daily_est_outdoor_usage_per_irrig_area] [float] NULL,
	[city_pct_diff_12mo_daily_est_outdoor_budget_overage_per_irrig_area] [float] NULL,
	[city_pct_diff_12mo_daily_est_outdoor_budget_overage_fraction_outdoor_budget] [float] NULL,
	[city_pct_diff_12mo_rebate_participation_fraction] [float] NULL,
	[city_pct_diff_12mo_turf_rebate_area_fraction] [float] NULL,
	...
	[hoa_sprinkler_nozzles_rebate_sum] [float] NULL,
	...
	[hoa_daily_outdoor_budget_per_irrig_area] [float] NULL,
	...
	[hoa_pct_diff_12mo_meter_over_total_budget_fraction] [float] NULL,
	[hoa_pct_diff_12mo_daily_meter_budget_overage_per_meter] [float] NULL,
	[hoa_pct_diff_12mo_meter_over_est_outdoor_budget_fraction] [float] NULL,
	[hoa_pct_diff_12mo_daily_meter_usage_per_capita_mean] [float] NULL,
	[hoa_pct_diff_12mo_daily_meter_est_outdoor_usage_per_capita_mean] [float] NULL,
	[hoa_pct_diff_12mo_daily_meter_budget_overage_fraction_total] [float] NULL,
	[hoa_pct_diff_12mo_daily_est_outdoor_usage_per_irrig_area] [float] NULL,
	[hoa_pct_diff_12mo_daily_est_outdoor_budget_overage_per_irrig_area] [float] NULL,
	[hoa_pct_diff_12mo_daily_est_outdoor_budget_overage_fraction_outdoor_budget] [float] NULL,
	[hoa_pct_diff_12mo_rebate_participation_fraction] [float] NULL,
	[hoa_pct_diff_12mo_turf_rebate_area_fraction] [float] NULL,
 ...
 CONSTRAINT [PK_RawDroolMetricStaging_RawDroolMetricStagingID] PRIMARY KEY CLUSTERED 
(
	[RawDroolMetricStagingID] ASC
